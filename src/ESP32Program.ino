// https://blog.csdn.net/qq_42494106/article/details/125092623
// 关于extern “C“ 出现error: expected identifier or ‘(‘ before string constant的问题
...
/*
  ...
  the C Language interpreter is based upon the picoc work of Zik Saleeba and Copyright (c) 2009-2011.
*/
...
#include "picoc.h"
  ...
  // https://stackoverflow.com/questions/75438483/conflicting-declaration-of-function-with-c-linkage
  // 报错：error: conflicting declaration of 'void sendContent(char*)' with 'C' linkage

  // void sendc(char it);   //lyx
  // void send(char * it);
...
String RunningProgramGui() // 从另外一个ino文件中挪过来的
{
