...
#define STRING_TABLE_SIZE 47                /* shared string table size */
#define STRING_LITERAL_TABLE_SIZE 47        /* string literal table size */
#define PARAMETER_MAX 14                   /* maximum number of parameters to a function */
#define LINEBUFFER_MAX 512                  /* maximum number of characters on a line */
#define LOCAL_TABLE_SIZE 51                 /* size of local variable table (can expand) */
#define STRUCT_TABLE_SIZE 51                /* size of struct/union member table (can expand) */
