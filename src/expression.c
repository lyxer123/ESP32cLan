...
extern struct StackFrame *TopStackFrame; // lyx-2023-9-16
    ...
    while (StackTop != NULL)
    {
        if (StackTop->Order == OrderNone)
        {
            ...
            case TypeChar:
                ...
                break;
            case TypeLong:
                printf("%d:long", StackTop->Val->Val->LongInteger);
                break;
            ...
            case TypeUnsignedLong:
                printf("%d:unsigned long", StackTop->Val->Val->UnsignedLongInteger);
                break;
            case TypeFP:
            ...
            case TypeEnum:
                ...
                break;
            case Type_Type:
                PrintType(StackTop->Val->Val->Typ);
                printf(":type");
                break;
            default:
                printf("unknown");
...
void ExpressionAssign(struct ParseState *Parser, struct Value *DestValue, struct Value *SourceValue, int Force, const char *FuncName, int ParamNo, int AllowPointerCoercion)
{
    ...
    case TypeShort:
        ...
        break;
    case TypeChar:
        DestValue->Val->Character = (char)ExpressionCoerceUnsignedInteger(SourceValue);
        break;
    case TypeLong:
